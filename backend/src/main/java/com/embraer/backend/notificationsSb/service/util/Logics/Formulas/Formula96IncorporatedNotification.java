...
@Service
public class Formula96IncorporatedNotification {
    ...
    public boolean formula96ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
