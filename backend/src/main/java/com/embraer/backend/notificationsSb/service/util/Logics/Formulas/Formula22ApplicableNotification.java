...
@Service
public class Formula22ApplicableNotification {
    ...
    public boolean formula22ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
