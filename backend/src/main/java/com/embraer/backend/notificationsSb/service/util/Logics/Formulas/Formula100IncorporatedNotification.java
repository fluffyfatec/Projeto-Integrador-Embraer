...
@Service
public class Formula100IncorporatedNotification {
    ...
    public boolean formula100ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
