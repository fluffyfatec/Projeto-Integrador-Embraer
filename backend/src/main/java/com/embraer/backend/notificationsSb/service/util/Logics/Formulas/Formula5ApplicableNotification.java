...
@Service
public class Formula5ApplicableNotification {
    ...
    public boolean formula5ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
