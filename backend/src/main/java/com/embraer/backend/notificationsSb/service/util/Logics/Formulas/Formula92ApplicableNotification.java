...
@Service
public class Formula92ApplicableNotification {
    ...
    public boolean formula92ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
        ...
        if (Objects.equals(chassiServiceBulletinRepository
                ...
                Objects.equals(chassiServiceBulletinRepository
                        .findSbStatusBySbId((condition.getSb4IdLong()), chassis), "APPLICABLE") &&
                Objects.equals(chassiServiceBulletinRepository
                        .findSbStatusBySbId((condition.getSb5IdLong()), chassis), "APPLICABLE") &&
                Objects.equals(chassiServiceBulletinRepository
                        .findSbStatusBySbId((condition.getSb6IdLong()), chassis), "APPLICABLE")) {
