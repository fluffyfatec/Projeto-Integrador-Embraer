...
@Service
public class Formula7IncorporatedNotification {
    ...
    public boolean formula7ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
