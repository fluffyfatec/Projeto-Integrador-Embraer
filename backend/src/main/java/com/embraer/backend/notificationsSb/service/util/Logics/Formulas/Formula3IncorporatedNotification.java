...
@Service
public class Formula3IncorporatedNotification {
    ...
    public boolean formula3ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
