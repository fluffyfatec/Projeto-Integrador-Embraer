...
@Service
public class Formula86IncorporatedNotification {
    ...
    public boolean formula86ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
