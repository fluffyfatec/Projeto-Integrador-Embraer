...
@Service
public class Formula82ApplicableNotification {
    ...
    public boolean formula82ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
