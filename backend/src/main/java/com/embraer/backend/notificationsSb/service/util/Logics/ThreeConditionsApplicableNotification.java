...
@Service
public class ThreeConditionsApplicableNotification {
    ...
    public boolean threeConditionsListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
