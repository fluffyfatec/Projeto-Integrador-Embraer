...
@Service
public class Formula98IncorporatedNotification {
    ...
    public boolean formula98ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
