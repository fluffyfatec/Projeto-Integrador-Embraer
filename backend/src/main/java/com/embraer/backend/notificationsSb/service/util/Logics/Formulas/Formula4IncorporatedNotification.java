...
@Service
public class Formula4IncorporatedNotification {
    ...
    public boolean formula4ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
