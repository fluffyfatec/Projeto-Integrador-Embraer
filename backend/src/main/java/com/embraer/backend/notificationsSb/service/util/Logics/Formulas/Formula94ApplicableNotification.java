...
@Service
public class Formula94ApplicableNotification {
    ...
    public boolean formula94ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
