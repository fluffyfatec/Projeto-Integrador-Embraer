...
@Service
public class FiveConditionsIncorporatedNotification {
    ...
    public boolean FiveConditionsListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
