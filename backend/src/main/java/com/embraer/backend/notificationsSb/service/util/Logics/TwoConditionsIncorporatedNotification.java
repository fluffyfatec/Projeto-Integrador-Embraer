...
@Service
public class TwoConditionsIncorporatedNotification {
    ...
    public boolean twoConditionsListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
