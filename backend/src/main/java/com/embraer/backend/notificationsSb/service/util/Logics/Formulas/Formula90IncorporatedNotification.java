...
@Service
public class Formula90IncorporatedNotification {
    ...
    public boolean formula90ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
