...
@Service
public class FiveConditionsApplicableNotification {
    ...
    public boolean fiveConditionsListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
        ...
        if (condition.getSb1IdLong() != null && condition.getSb7IdLong() != null &&
            ...
            if (Objects.equals(chassiServiceBulletinRepository
                    ...
                    Objects.equals(chassiServiceBulletinRepository
                            .findSbStatusBySbId((condition.getSb19IdLong()), chassis), "APPLICABLE") &&
                    Objects.equals(chassiServiceBulletinRepository
                            .findSbStatusBySbId((condition.getSb25IdLong()), chassis), "APPLICABLE")) {
                ...
                return true;
                    ...
                    Objects.equals(chassiServiceBulletinRepository
                            .findSbStatusBySbId((condition.getSb19IdLong()), chassis), "APPLICABLE") &&
                    Objects.equals(chassiServiceBulletinRepository
                            .findSbStatusBySbId((condition.getSb25IdLong()), chassis), "INCORPORATED")) {
