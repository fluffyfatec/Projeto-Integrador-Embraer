...
@Service
public class Formula88ApplicableNotification {
    ...
    public boolean formula88ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
