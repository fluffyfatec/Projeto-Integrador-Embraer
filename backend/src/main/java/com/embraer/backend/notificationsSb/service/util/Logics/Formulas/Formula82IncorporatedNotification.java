...
@Service
public class Formula82IncorporatedNotification {
    ...
    public boolean formula82ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
