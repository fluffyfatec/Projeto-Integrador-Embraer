...
@Service
public class Formula94IncorporatedNotification {
    ...
    public boolean formula94ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
