...
@Service
public class Formula22IncorporatedNotification {
    ...
    public boolean formula22ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
