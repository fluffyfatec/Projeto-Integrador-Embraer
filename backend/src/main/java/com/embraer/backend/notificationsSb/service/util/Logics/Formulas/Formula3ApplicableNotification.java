...
@Service
public class Formula3ApplicableNotification {
    ...
    public boolean formula3ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
