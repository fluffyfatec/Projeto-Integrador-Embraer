...
@Service
public class Formula92IncorporatedNotification {
    ...
    public boolean formula92ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
