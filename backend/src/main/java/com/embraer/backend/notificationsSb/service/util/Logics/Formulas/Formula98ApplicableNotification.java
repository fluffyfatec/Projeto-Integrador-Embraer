...
@Service
public class Formula98ApplicableNotification {
    ...
    public boolean formula98ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
