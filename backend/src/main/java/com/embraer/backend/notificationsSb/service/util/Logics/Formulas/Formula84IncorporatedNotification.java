...
@Service
public class Formula84IncorporatedNotification {
    ...
    public boolean formula84ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
