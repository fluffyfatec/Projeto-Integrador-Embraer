...
@Service
public class Formula4ApplicableNotification {
    ...
    public boolean formula4ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
