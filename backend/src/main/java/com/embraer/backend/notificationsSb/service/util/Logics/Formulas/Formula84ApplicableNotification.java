...
@Service
public class Formula84ApplicableNotification {
    ...
    public boolean formula84ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
