...
@Service
public class TwoConditionsApplicableNotification {
    ...
    public boolean twoConditionsListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
