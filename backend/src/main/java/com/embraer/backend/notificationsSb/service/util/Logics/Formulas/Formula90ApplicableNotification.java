...
@Service
public class Formula90ApplicableNotification {
    ...
    public boolean formula90ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
