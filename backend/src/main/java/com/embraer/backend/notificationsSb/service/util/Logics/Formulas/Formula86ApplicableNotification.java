...
@Service
public class Formula86ApplicableNotification {
    ...
    public boolean formula86ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
