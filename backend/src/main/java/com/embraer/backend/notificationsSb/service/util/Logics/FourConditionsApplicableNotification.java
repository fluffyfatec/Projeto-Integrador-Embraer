...
@Service
public class FourConditionsApplicableNotification {
    ...
    public boolean fourConditionsListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
