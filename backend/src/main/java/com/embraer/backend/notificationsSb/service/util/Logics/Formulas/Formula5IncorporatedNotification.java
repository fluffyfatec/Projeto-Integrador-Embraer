...
@Service
public class Formula5IncorporatedNotification {
    ...
    public boolean formula5ListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
