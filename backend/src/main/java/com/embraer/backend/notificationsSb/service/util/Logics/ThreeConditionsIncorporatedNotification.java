...
@Service
public class ThreeConditionsIncorporatedNotification {
    ...
    public boolean threeConditionsListIncorporated(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
