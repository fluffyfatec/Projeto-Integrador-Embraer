...
@Service
public class Formula7ApplicableNotification {
    ...
    public boolean formula7ListApplicable(Condition condition, Long chassis, Long userId, Long sbId, String operation) {
