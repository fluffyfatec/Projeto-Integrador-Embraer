...
public class PdfOwner {
    ...
    public static ByteArrayInputStream exportReportOwner (List<ChassisUserOwnerDTO> owners, String userName) throws IOException {
        ...
        try {
            ...
            hcell = new PdfPCell(new Phrase("User Owner", headFont));
            ...
            for (ChassisUserOwnerDTO owner : owners) {
                ...
                cell = new PdfPCell(new Phrase(owner.getOwner(), font));
                ...
                cell = new PdfPCell(new Phrase(owner.getChassis().toString(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                ...
                cell = new PdfPCell(new Phrase(owner.getDate_register(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            Paragraph title = new Paragraph(new Phrase("Report of Owners", fontTitle));
