...
public class PdfSbs {
    ...
    public static ByteArrayInputStream exportReportSbs (List<ListChassiBySbDto> chassis,
                                                           String sb, String part, String userName) throws IOException {


        if (part.equals("UNICO")) {
            part = "UNIQUE";
        }
        ...
        try {
            ...
            for (ListChassiBySbDto chassi : chassis) {
                ...
                cell = new PdfPCell(new Phrase(chassi.getChassi().toString(), font));
                ...
                cell = new PdfPCell(new Phrase(chassi.getSb_status(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            Paragraph title = new Paragraph(new Phrase("Report of " + sb + " " + part, fontTitle));
