...
public class PdfPilot {

    public static ByteArrayInputStream exportReportPilot (List<ChassisUserPilotDTO> pilots, String userName) throws IOException {
        ...
        try {
            ...
            table.setWidths(new int[] { 4, 3, 4, 5, 3});
            ...
            hcell = new PdfPCell(new Phrase("Chassis", headFont));
            hcell.setPaddingTop(9f);
            hcell.setFixedHeight(50f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            hcell = new PdfPCell(new Phrase("Pilot", headFont));
            hcell.setPaddingTop(9f);
            hcell.setFixedHeight(50f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            hcell = new PdfPCell(new Phrase("Date Register", headFont));
            hcell.setPaddingTop(9f);
            hcell.setFixedHeight(50f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            for (ChassisUserPilotDTO pilot : pilots) {
                ...
                cell = new PdfPCell(new Phrase(pilot.getOwner(), font));
                ...
                cell = new PdfPCell(new Phrase(pilot.getChassis().toString(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                ...
                cell = new PdfPCell(new Phrase(pilot.getPilot(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                ...
                cell = new PdfPCell(new Phrase(pilot.getDate_register(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            Paragraph title = new Paragraph(new Phrase("Report of Pilots", fontTitle));
