...
public class PdfPlanes {

    public static ByteArrayInputStream exportReportPlanes (List<ListServiceBulletinsResponse> sbs,
        ...
        try {
            ...
            hcell = new PdfPCell(new Phrase("Service Bulletin", headFont));
            ...
            hcell = new PdfPCell(new Phrase("Part", headFont));
            hcell.setPaddingTop(9f);
            hcell.setFixedHeight(50f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            for (ListServiceBulletinsResponse sb : sbs) {
                ...
                cell = new PdfPCell(new Phrase(sb.getService_bulleti_name(), font));
                ...
                cell = new PdfPCell(new Phrase(sb.getStatus(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
