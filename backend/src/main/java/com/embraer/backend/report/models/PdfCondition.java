...
public class PdfCondition {

    public static ByteArrayInputStream exportReportCondition (List<ItemDTO> items, String userName) throws IOException {
        ...
        try {
            ...
            for (ItemDTO item : items) {
                ...
                cell = new PdfPCell(new Phrase(item.getItemDtregister(), font));
                cell.setPaddingTop(2f);
                cell.setFixedHeight(32f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            Paragraph title = new Paragraph(new Phrase("Report of Items", fontTitle));
